...
de evento definida como a probabilidade do sucesso do evento sobre a probabilidade do fracasso. (Hosmer e Lemeshow)
...
Logo, para o crescimento de 1 unidade em $X$, a chance do evento ocorrer aumento em $\beta_k$ unidades.
