...
% TODO: por gráficos de validação e teste
...
\begin{figure}[H]
  \centering
  \subImagem{imagens/shap/shap_plot_verdadeiro_positivo.png}{Valor de SHAP para uma observação do tipo Verdadeiro Positivo}
  \vspace{.5cm}
  \subImagem{imagens/shap/shap_plot_falso_positivo.png}{Valor de SHAP para uma observação do tipo Falso Positivo}
  \vspace{.5cm}
  \subImagem{imagens/shap/shap_plot_verdadeiro_negativo.png}{Valor de SHAP para uma observação do tipo Verdadeiro Negativo}
  \subImagem{imagens/shap/shap_plot_falso_negativo.png}{Valor de SHAP para uma observação do tipo Falso Negativo}
  
  \label{fig:shap_cada_obs}
  \caption{Representação do valor de SHAP para cada observação}
\end{figure}

A Figura \ref{fig:shap_cada_obs} proporciona a visualização dos valores SHAP para cada variável em observações individuais.
